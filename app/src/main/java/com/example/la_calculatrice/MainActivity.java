    package com.example.la_calculatrice;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void remplaceVirgule(){//remplacer une virgule par un point
    ...
    public void remplacePoint(){//remplacer un point par une virgule
        StringBuilder chaine = new StringBuilder();
    ...
    public void clear(){//cest pour réinitialiser tout
    ...
    public void addNumberAndOp(View v){
        if(chaine_nombre.isEmpty()){
            if(!vue1.isEmpty()){//cest pour changer le dernier opérateur
                StringBuilder chaine = new StringBuilder();
            ...
            if(vue1.isEmpty()){//cest pour  ajouter le premier op et le premier nombre
